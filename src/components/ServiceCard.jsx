...
export default function ServiceCard({ title, desc, icon }) {
    return (
        <div className="p-10 bg-white/5 border border-white/5 rounded-[40px] hover:border-amber-500/50 transition group">
            <div className="text-amber-500 mb-6 group-hover:scale-110 transition-transform">{iconMap[icon]}</div>
            <h3 className="text-white text-xl font-bold italic uppercase mb-4 tracking-tight">{title}</h3>
