        ...
        <section className="py-24 relative overflow-hidden border-y border-white/5">
            <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-5xl font-black italic uppercase text-white tracking-tighter mb-6">{coverageContent.title} <span className="text-amber-500">{coverageContent.highlight}</span></h2>
