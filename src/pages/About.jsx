        ...
        <div className="bg-[#0B0F19] min-h-screen font-sans pt-[60px] md:pt-[75px]">
            ...
            <section className="py-16 md:py-24 relative overflow-hidden">
                <div className="max-w-[85rem] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                    ...
                    <div className="w-full lg:w-1/2">
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black italic uppercase text-white tracking-tighter mb-6 md:mb-8">A Legacy of <span className="text-amber-500">Excellence</span></h2>
            ...
            <section className="py-16 md:py-24 relative overflow-hidden">
                <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black italic uppercase text-white tracking-tighter">Our Core <span className="text-amber-500">Values</span></h2>
                    </div>
