...
export default function Services() {
    ...
    const ecoTitle1 = sp?.eco_title_1 || '';
    const ecoTitle2 = sp?.eco_title_2 || '';
    const ecoPara1 = sp?.eco_para_1 || '';
    const ecoPara2 = sp?.eco_para_2 || '';
    const ecoFeature1 = sp?.eco_feature_1 || '';
    const ecoFeature2 = sp?.eco_feature_2 || '';
    const ecoFeature3 = sp?.eco_feature_3 || '';
                ...
                <div className="max-w-[85rem] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="aspect-[4/3] rounded-[24px] md:rounded-[40px] overflow-hidden shadow-2xl relative">
                            <img src={resolveImage("bus-fleet.jpg")} loading="lazy" decoding="async" className="w-full h-full object-cover" alt="Service Detail" />
                        </div>
                    </div>
                </div>
            </section>
